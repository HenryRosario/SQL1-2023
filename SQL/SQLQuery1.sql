...
--3 - Insertar y recuperar registros de una tabla (insert into - select)
 ...
 insert into agenda (apellido, nombre, domicilio, telefono)
  values ('Ramon','Emilio','Rosario 123','4234567');
 insert into agenda (apellido,nombre, domicilio, telefono)
  values ('Jimenez','Maria','Avellaneda 135','4458787');
 ...
 insert into libros (titulo,autor,editorial)
  values ('Samuel','Borges','Garcias');
 insert into libros (titulo,autor,editorial) 
  values ('Yanibel','De la cruz','rodriguez');
 insert into libros (titulo,autor,editorial)
  values ('Aprenda SQL','Mario','Emece');
 ...
 insert into empleados (nombre, documento, sexo, domicilio, sueldobasico)
  values ('Eladio Barrios','27888999','m','Urquiza 479',800);
